const PixiJS = require('../../../src/renderers/pixijs/Widget').default

describe('PixiJS', function () {
  describe('#classes', function () {
    it('should not contain previous classes removed from source latex', function () {
      const widget = new PixiJS('\\class{a}{1} + \\class{b}{2} = 3')
